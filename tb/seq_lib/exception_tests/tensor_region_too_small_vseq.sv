`ifndef TENSOR_REGION_TOO_SMALL_VSEQ_SV
`define TENSOR_REGION_TOO_SMALL_VSEQ_SV

class tensor_region_too_small_vseq extends base_vseq;
  `uvm_object_utils(tensor_region_too_small_vseq)
  ...
  function new(string name = "tensor_region_too_small_vseq");
    super.new(name);
  endfunction

  virtual task body();
    too_small_case_t too_small_cases[$];

    too_small_cases.push_back('{32'd12, 32'h0000_1000, 32'h0000_1000,
                                32'h0000_1000, POST_NONE});
    too_small_cases.push_back('{32'h0000_1000, 32'd12, 32'h0000_1000,
                                32'h0000_1000, POST_NONE});
    too_small_cases.push_back('{32'h0000_1000, 32'h0000_1000, 32'd60,
                                32'h0000_1000, POST_NONE});
    too_small_cases.push_back('{32'h0000_1000, 32'h0000_1000, 32'h0000_1000,
                                32'd12, POST_BIAS});

    foreach (too_small_cases[i]) begin
      run_too_small_case(too_small_cases[i]);
    end
  endtask

  protected virtual task run_too_small_case(too_small_case_t too_small_case);
    ...
    `uvm_info(get_type_name(),
              $sformatf("Running region-too-small case A_SIZE=0x%08x B_SIZE=0x%08x C_SIZE=0x%08x BIAS_SIZE=0x%08x post_op=%0d",
                        too_small_case.a_spad_size, too_small_case.b_spad_size,
                        too_small_case.c_spad_size, too_small_case.bias_spad_size,
                        too_small_case.post_op),
              UVM_MEDIUM)
    ...
    program_seq.post_op = too_small_case.post_op;
    ...
    program_seq.a_spad_size = too_small_case.a_spad_size;
    program_seq.b_spad_offset = 32'h0000_2000;
    program_seq.b_spad_size = too_small_case.b_spad_size;
    program_seq.c_spad_offset = 32'h0000_4000;
    program_seq.c_spad_size = too_small_case.c_spad_size;
    program_seq.bias_spad_offset = 32'h0000_6000;
    program_seq.bias_spad_size = too_small_case.bias_spad_size;
    ...
    wait_seq.exp_error_code = ERR_REGION_TOO_SMALL;
  ...
  protected virtual task check_error_state();
    ...
    expected_error_code = ERR_REGION_TOO_SMALL;
    ...
    else if (actual_error_code != ERR_REGION_TOO_SMALL) begin
      `uvm_error(get_type_name(),
