package tensor_pkg;
  ...
  function automatic logic relu_enabled(input post_op_e op);
    relu_enabled = (op == POST_RELU) || (op == POST_BIAS_RELU);
  endfunction
